...
<div class="Details" <?php
	...
	<div class="bg0">
		<h1>Water Parameter Details ( Form-1B )</h1>
			<div class="formCont">
			<div class="cont" ><label>DO (mg/lt.)	<span>(> 5)</span> : </label><br></div>
			<input type="text" value="" name="Fname" required="required" >
		</div>
			<div class="formCont">
			<div class="cont" ><label>CO2 (mg/lt.)	<span>(< 16)</span></label><br></div>
			<input type="text" name="disease">
		</div>
		<div class="formCont">
			<div class="cont" ><label>Total Alkalinity (mg/lt.)	<span>(80 - 110	)</span> : </label><br></div>
			<input type="text" value="" name="Oblock" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Hardness (mg/lt.)	<span>(70 - 100 )</span>: </label><br></div>
			<input type="text" value="" name="Ogp" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Ammonia (mg/lt.)	<span>(< 0.2)</span> : </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Potassium ( μg )	<span>(> 1.0)</span>: </label><br></div>
			<input type="text" value="" name="Opo" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Calcium ( μg )	<span>(24 - 28)</span>: </label><br></div>
			<input type="text" value="" name="Fname" required="required" >
		</div>
			<div class="formCont">
			<div class="cont" ><label>Sodium ( μg )<span>(	7.9 - 9.0)</span></label><br></div>
			<input type="text" name="disease">
		</div>
		<div class="formCont">
			<div class="cont" ><label>Iron	<span>(< 0.2	)</span> : </label><br></div>
			<input type="text" value="" name="Oblock" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Chloride	<span>(10)</span> : </label><br></div>
			<input type="text" value="" name="Ogp" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>H2S (mg/lt.)	<span>(< 1 )</span>: </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Heavy Metals	<span>(As per CPCB standards)</span>	: </label><br></div>
			<input type="text" value="" name="Opo" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Traces of <span>(Pesticides	As per CPCB standards)</span>	: </label><br></div>
			<input type="text" value="" name="Opo" required="required" >
		</div>
