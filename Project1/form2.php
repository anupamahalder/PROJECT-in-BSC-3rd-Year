...
<div class="Details" <?php
	...
	<div class="bg0">
		<h1>Assessment of Brooder Stock ( Form-2 )</h1>
		<div class="formCont">
			...
			<div class="formCont">
			<div class="cont" ><label>General Health : </label><br></div>
			<select name="name" required="required">
				<option>Good</option>
		...
		<div class="formCont">
			<div class="cont" ><label>No. of years using the same Brooder : </label><br></div>
	...
	<div class="bg1">
		...
		<div class="formCont">
			<div class="cont" ><label>Total Weight (Kg.) : </label><br></div>
			<input type="text" value="" name="Oblock" required="required" >
		</div>
	</div>
	<div class="bg0">
		<h2>Female Brooder</h2>
		<div class="formCont">
			<div class="cont" ><label>Number</label><br></div>
			<input type="text" name="disease">
		</div>
	...
	<div class="bg1">
		<h2>Origin of present Brood Stock</h2>
		<div class="formCont">
			<div class="cont" ><label>Source</label><br></div>
				<select name="name" required="required">
				<option>River</option>
				<option>Open water body</option>
				<option>Wild collection</option>
				<option>Hatchery</option>
				<option>Aquaculture farm</option>
			</select>
		</div>
		<div class="formCont">
			<div class="cont" ><label> Place of Collection : </label><br></div>
			<input type="text" value="" name="Oblock" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Year of Collection : </label><br></div>
			<input type="text" value="" name="Oblock" required="required" >
		</div>
	</div>
	<br><br>
