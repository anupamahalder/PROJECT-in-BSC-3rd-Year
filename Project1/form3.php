...
<div class="Details" <?php
	...
	<div class="bg0">
		<h1>Owner's Family and Water Body Details ( Form-3 )</h1>
		<div class="formCont">
			<div class="cont" ><label>Religion: </label><br></div>
		...
		<div class="formCont">
			<div class="cont" ><label>Caste :</label><br></div>
			<select name="name" required="required">
	...
	<div class="bg1">
		...
		<div class="formCont">
			<div class="cont" ><label>Male : </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Female: </label><br></div>
			<input type="text" value="" name="Opo" required="required" >
		</div>
	</div>
	<div class="bg0">
		<div class="formCont">
			<div class="cont" ><label>Total income of the Family per month (Rs.) : </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Percentage (%) of income from Hatchery / Seed Farm sector : </label><br></div>
			<input type="text" value="" name="Opo" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Details of aid / loan received from Fisheries Department: </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Details of aid / loan received from Other Department : </label><br></div>
			<input type="text" value="" name="Opo" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Details of Hatchery Infrastructure Facility received from any Department : </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Details of expected help to be received from Fisheries Department	: </label><br></div>
			<input type="text" value="" name="Opo" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Details of Training received on Hatchery / Seed Farm Management: </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Details of scarcity related to Brood Fish / Fish spawn : </label><br></div>
			<input type="text" value="" name="Opo" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Specify suggestion in relation to Hatchery / Seed Farm : </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
	</div>
	<div class="bg1">
		<h2> Possession of Water Body (if any)</h2>
		<table>
			<tr>
				<th>Sl No.</th>
				<th>Block</th>
			...
			<tr>
				...
				<td><input type="text" name="mouza"></td>
				<td><select>
					<option>Own</option>
					<option>Lease</option>
				</select></td>
