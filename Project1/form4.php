...
<div class="Details" <?php
	...
	<div class="bg0">
		<h1>Disease Information ( Form-4 )</h1>
		<div class="formCont">
			...
			<div class="formCont">
			<div class="cont" ><label>Occurence of Disease(Year) : </label><br></div>
			<input type="text" value="" name="Fname" required="required" >
		</div>
			<div class="formCont">
			<div class="cont" ><label>Description of Disease</label><br></div>
			<input type="text" name="disease">
		</div>
		<div class="formCont">
			<div class="cont" ><label>Which portion of the body affected	 : </label><br></div>
			<input type="text" value="" name="Oblock" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Progress of disease (in days) : </label><br></div>
			<input type="text" value="" name="Ogp" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Probable cause of the disease : </label><br></div>
			<input type="text" value="" name="Ovillage" required="required" >
		</div>
		<div class="formCont">
			<div class="cont" ><label>Treatment / Preventive measures taken	: </label><br></div>
