...
<div class="Details" <?php
	...
	<div class="bg0">
		<h1>Species wise Seed Procurement Details ( Form-6 )</h1>
		<div class="formCont">
			...
			<div class="formCont">
			<div class="cont" ><label>From where the Seed has been received : </label><br></div>
			<input type="text" value="" name="Fname" required="required" >
		</div>
			<div class="formCont">
			<div class="cont" ><label>Received Quantity (in millions)</label><br></div>
